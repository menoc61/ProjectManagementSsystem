                        ...
                        <div class="col-md-6">
                            <div class="card bg-light mb-3">
                                <div class="card-body">
                                    ...
                                    <h2 class="card-text text-primary"><?php echo number_format($reglement['MontantReglement'], 2, ',', ' '); ?> €</h2>
                                    <p class="card-text"><strong>Mode:</strong> <?php echo htmlspecialchars($reglement['ModeReglement']); ?></p>
                                    <?php if (!empty($reglement['ReferenceReglement'])): ?>
                                    <p class="card-text"><strong>Référence:</strong> <?php echo htmlspecialchars($reglement['ReferenceReglement']); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Total projets:</strong> <?php echo number_format($totalProjets, 2, ',', ' '); ?> €</p>
                                        <p><strong>Total règlements:</strong> <?php echo number_format($totalReglements, 2, ',', ' '); ?> €</p>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($projet['CoutProjet'], 2, ',', ' '); ?> €</td>
                                        <td class="no-print">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($autreReglement['MontantReglement'], 2, ',', ' '); ?> €</td>
