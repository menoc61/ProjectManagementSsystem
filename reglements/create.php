...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO REGLEMENT (IdClient, DateReglement, HeureReglement, MontantReglement, ModeReglement, ReferenceReglement, CommentaireReglement) 
            VALUES ('$idClient', '$dateReglement', '$heureReglement', '$montantReglement', '$modeReglement', '$referenceReglement', '$commentaireReglement')";
                    ...
                    <div class="card-body">
                        <form method="post" action="create.php">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="referenceReglement" name="referenceReglement">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="commentaireReglement" name="commentaireReglement" rows="3"></textarea>
                            </div>
