...
<body>
    ...
    <div class="card">
        ...
        <?php endif; ?>
        <div class="montant">Montant: <?php echo number_format($reglement['MontantReglement'], 2, ',', ' '); ?> €</div>
    ...
    <table>
        <tr>
            <th>Total projets</th>
            <td><?php echo number_format($totalProjets, 2, ',', ' '); ?> €</td>
        </tr>
        <tr>
            <th>Total règlements</th>
            <td><?php echo number_format($totalReglements, 2, ',', ' '); ?> €</td>
        </tr>
        <tr>
            <th>Solde</th>
            <td><?php echo number_format($solde, 2, ',', ' '); ?> €</td>
        </tr>
    </table>
    ...
    <div class="card">
        ...
        <table>
            <tr>
                ...
                <td><?php echo number_format($totalMontant, 2, ',', ' '); ?> €</td>
            </tr>
            <tr>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo number_format($row['MontantReglement'], 2, ',', ' '); ?> €</td>
