                ...
                <div class="projet-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="projet-info"><strong>Coût:</strong> <?php echo number_format($projet['CoutProjet'], 2, ',', ' '); ?> €</p>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p><strong>Coût du projet:</strong> <?php echo number_format($projet['CoutProjet'], 2, ',', ' '); ?> €</p>
                                        <p><strong>Forfait type de projet:</strong> <?php echo number_format($projet['ForfaitCoutTypeProjet'], 2, ',', ' '); ?> €</p>
                                        <p><strong>Total des règlements:</strong> <?php echo number_format($totalReglements, 2, ',', ' '); ?> €</p>
                                        <p><strong>Solde:</strong> <span class="<?php echo $solde > 0 ? 'text-danger' : 'text-success'; ?>"><?php echo number_format($solde, 2, ',', ' '); ?> €</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($reglement['MontantReglement'], 2, ',', ' '); ?> €</td>
                                        <td class="no-print">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th><?php echo number_format($totalReglements, 2, ',', ' '); ?> €</th>
                                        <th></th>
                                    </tr>
                                </tfoot>
                            </table>
