...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkSql = "SELECT * FROM UTILISATEUR WHERE EmailUtilisateur = '$emailUtilisateur'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $sql = "INSERT INTO UTILISATEUR (NomUtilisateur, EmailUtilisateur, MotDePasseUtilisateur, RoleUtilisateur) 
                VALUES ('$nomUtilisateur', '$emailUtilisateur', '$hashedPassword', '$roleUtilisateur')";
