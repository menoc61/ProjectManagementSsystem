...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkSql = "SELECT * FROM UTILISATEUR WHERE EmailUtilisateur = '$emailUtilisateur' AND IdUtilisateur != $id";
                    ...
                    <div class="card-body">
                        <form method="post" action="edit.php?id=<?php echo $id; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="emailUtilisateur" name="emailUtilisateur" value="<?php echo htmlspecialchars($utilisateur['EmailUtilisateur']); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="roleUtilisateur" name="roleUtilisateur" required>
                                    ...
                                    <option value="admin" <?php echo $utilisateur['RoleUtilisateur'] == 'admin' ? 'selected' : ''; ?>>Administrateur</option>
                                    <option value="personnel" <?php echo $utilisateur['RoleUtilisateur'] == 'personnel' ? 'selected' : ''; ?>>Personnel</option>
                                </select>
                            </div>
