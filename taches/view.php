...
$dateFinTache = new DateTime($tache['DateFinTache']);
$aujourdhui = new DateTime();
$joursRestants = $dateFinTache->diff($aujourdhui)->days;
$retard = ($aujourdhui > $dateFinTache && $tache['EtatTache'] != 3 && $tache['EtatTache'] != 4);
?>
                ...
                <div class="tache-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="tache-info"><strong>Client:</strong> <a href="../clients/view.php?id=<?php echo $tache['IdClient']; ?>"><?php echo htmlspecialchars($tache['NomClient']); ?></a></p>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../personnel/view.php?id=<?php echo $affectation['IdPersonnel']; ?>">
