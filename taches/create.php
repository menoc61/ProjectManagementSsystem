...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO TACHE (LibelleTache, DescriptionTache, DateEnregTache, DateDebutTache, DateFinTache, EtatTache, IdProjet) 
            VALUES ('$libelleTache', '$descriptionTache', '$dateEnregTache', '$dateDebutTache', '$dateFinTache', '$etatTache', '$idProjet')";
                    ...
                    <div class="card-body">
                        <form method="post" action="create.php">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descriptionTache" name="descriptionTache" rows="3"></textarea>
                            </div>
