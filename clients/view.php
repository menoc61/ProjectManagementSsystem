                ...
                <div class="client-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="client-info"><strong>Solde:</strong> <span class="<?php echo $solde > 0 ? 'text-danger' : 'text-success'; ?>"><?php echo number_format($solde, 2, ',', ' '); ?> €</span></p>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th><?php echo number_format($totalProjets, 2, ',', ' '); ?> €</th>
                                        <th colspan="4"></th>
                                    </tr>
                                </tfoot>
                            </table>
                            ...
                            <div class="col-md-6">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <h2 class="card-text text-primary"><?php echo number_format($totalProjets, 2, ',', ' '); ?> €</h2>
                            ...
                            <div class="col-md-6">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <h2 class="card-text text-success"><?php echo number_format($totalReglements, 2, ',', ' '); ?> €</h2>
