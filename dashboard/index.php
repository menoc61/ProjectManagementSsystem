...
$projetsMontantSql = "SELECT SUM(MontantProjet) as total FROM PROJET";
...
// Projets récents
$projetsRecentsSql = "SELECT p.*, c.RaisonSocialeClient, tp.LibelleTypeProjet 
                      FROM PROJET p 
...
// Règlements récents
$reglementsRecentsSql = "SELECT r.*, c.RaisonSocialeClient 
                         FROM REGLEMENT r 
...
for ($i = 5; $i >= 0; $i--) {
    ...
    $projetsMoisSql = "SELECT SUM(MontantProjet) as total 
                       FROM PROJET 
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h2 class="mb-0"><?php echo number_format($projetsMontantTotal, 2, ',', ' '); ?> €</h2>
                                    </div>
                                    <div class="stat-icon">
                            ...
                            <div class="card-body">
                                <div class="list-group">
                                    ...
                                    <a href="../projets/view.php?id=<?php echo $projet['IdProjet']; ?>" class="list-group-item list-group-item-action">
                                        ...
                                        <p class="mb-1"><?php echo htmlspecialchars($projet['RaisonSocialeClient']); ?></p>
                            ...
                            <div class="card-body">
                                <div class="list-group">
                                    ...
                                    <a href="../reglements/view.php?id=<?php echo $reglement['IdReglement']; ?>" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h6 class="mb-1"><?php echo htmlspecialchars($reglement['RaisonSocialeClient']); ?></h6>
                                            <small><?php echo date('d/m/Y', strtotime($reglement['DateReglement'])); ?></small>
                                        </div>
                                        <p class="mb-1"><?php echo htmlspecialchars($reglement['ModeReglement']); ?></p>
                                        <small class="text-muted"><?php echo number_format($reglement['MontantReglement'], 2, ',', ' '); ?> €</small>
                                    </a>
                                    <?php endwhile; ?>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-light">
                                            <div class="card-body text-center">
                                                ...
                                                <h3 class="text-success"><?php echo number_format($projetsMontantTotal, 2, ',', ' '); ?> €</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card bg-light">
                                            <div class="card-body text-center">
                                                ...
                                                <h3 class="text-primary"><?php echo number_format($reglementsTotal, 2, ',', ' '); ?> €</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card bg-light">
                                            <div class="card-body text-center">
                                                ...
                                                <h3 class="text-danger"><?php echo number_format($soldeTotal, 2, ',', ' '); ?> €</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        const etatProjetChart = new Chart(etatProjetCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo isset($projetsEtat['En cours']) ? $projetsEtat['En cours'] : 0; ?>,
                        <?php echo isset($projetsEtat['Terminé']) ? $projetsEtat['Terminé'] : 0; ?>,
                        <?php echo isset($projetsEtat['En attente']) ? $projetsEtat['En attente'] : 0; ?>
                    ],
                    backgroundColor: [
                        'rgba(0, 123, 255, 0.7)',
                        'rgba(40, 167, 69, 0.7)',
        ...
        const etatTacheChart = new Chart(etatTacheCtx, {
            type: 'doughnut',
            data: {
                labels: ['En cours', 'Terminée', 'À faire'],
                datasets: [{
                    data: [
                        <?php echo isset($tachesEtat['En cours']) ? $tachesEtat['En cours'] : 0; ?>,
                        <?php echo isset($tachesEtat['Terminée']) ? $tachesEtat['Terminée'] : 0; ?>,
                        <?php echo isset($tachesEtat['À faire']) ? $tachesEtat['À faire'] : 0; ?>
                    ],
                    backgroundColor: [
                        'rgba(0, 123, 255, 0.7)',
                        'rgba(40, 167, 69, 0.7)',
