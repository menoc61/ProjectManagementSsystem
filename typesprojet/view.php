            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="type-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="type-info"><strong>Forfait coût:</strong> <?php echo number_format($typeProjet['ForfaitCoutTypeProjet'], 2, ',', ' '); ?> €</p>
                            <p class="type-info"><strong>Nombre de projets:</strong> <?php echo $projetsCount; ?></p>
                            <p class="type-info"><strong>Coût total des projets:</strong> <?php echo number_format($totalCout, 2, ',', ' '); ?> €</p>
                        </div>
                    </div>
                </div>
