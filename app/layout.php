...
function render_header(string $title, string $active = ''): void
{
    ...
    <head>
        ...
        <link href="<?= e(app_url('public/assets/vendor/bootstrap/bootstrap.min.css')) ?>" rel="stylesheet">
        <link href="<?= e(app_url('public/assets/vendor/fontawesome/all.min.css')) ?>" rel="stylesheet">
...
function render_footer(): void
{
    ...
    <script src="<?= e(app_url('public/assets/vendor/bootstrap/bootstrap.bundle.min.js')) ?>"></script>
