                        ...
                        <div class="col-md-6">
                            <div class="card bg-light mb-3">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><strong>Client:</strong> <?php echo htmlspecialchars($affectation['RaisonSocialeClient']); ?></p>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="list-group">
                                    <a href="../personnel/view.php?id=<?php echo $affectation['IdPersonnel']; ?>" class="list-group-item list-group-item-action">
