...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkSql = "SELECT * FROM AFFECTATION WHERE IdPersonnel = $idPersonnel AND IdTache = $idTache AND IdAffectation != $id";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $sql = "UPDATE AFFECTATION SET 
                ...
                CommentairesAffectation = '$commentairesAffectation' 
                        ...
                        <form method="post" action="edit.php?id=<?php echo $id; ?>">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="idPersonnel" name="idPersonnel" required>
                                    ...
                                    ?>
                                    <option value="<?php echo $personnel['IdPersonnel']; ?>" <?php echo $affectation['IdPersonnel'] == $personnel['IdPersonnel'] ? 'selected' : ''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="commentairesAffectation" name="commentairesAffectation" rows="3"><?php echo htmlspecialchars($affectation['CommentairesAffectation']); ?></textarea>
                            </div>
