...
$sql = "SELECT * FROM SERVICE $where ORDER BY LibelleService";
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>" . htmlspecialchars($row['LibelleService']) . "</td>";
                                    echo "<td>" . htmlspecialchars($row['DescriptionService']) . "</td>";
                                    echo "<td>";
                                    echo "<a href='view.php?id=" . $serviceId . "' class='btn btn-sm btn-info me-1'><i class='bi bi-eye'></i></a>";
                                    echo "<a href='edit.php?id=" . $serviceId . "' class='btn btn-sm btn-warning me-1'><i class='bi bi-pencil'></i></a>";
                                    echo "<a href='delete.php?id=" . $serviceId . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Êtes-vous sûr de vouloir supprimer ce service ?\")'><i class='bi bi-trash'></i></a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
