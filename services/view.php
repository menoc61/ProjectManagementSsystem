...
$personnelSql = "SELECT * FROM PERSONNEL WHERE IdService = $id ORDER BY NomPersonnel";
                ...
                <div class="service-header">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="service-info"><strong>ID:</strong> <?php echo $service['IdService']; ?></p>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $personnel['IdPersonnel']; ?></td>
                                ...
                                <td class="no-print">
                                    <a href="../personnel/view.php?id=<?php echo $personnel['IdPersonnel']; ?>" class="btn btn-sm btn-info me-1"><i class="bi bi-eye"></i></a>
                                    <a href="../personnel/edit.php?id=<?php echo $personnel['IdPersonnel']; ?>" class="btn btn-sm btn-warning me-1"><i class="bi bi-pencil"></i></a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
