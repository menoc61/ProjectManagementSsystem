...
$tachesEnCoursSql = "SELECT COUNT(*) as count 
                     FROM AFFECTATION a 
                     JOIN TACHE t ON a.IdTache = t.IdTache 
                     WHERE a.IdPersonnel = $id AND t.EtatTache = 'En cours'";
...
$tachesTermineesSql = "SELECT COUNT(*) as count 
                       FROM AFFECTATION a 
                       JOIN TACHE t ON a.IdTache = t.IdTache 
                       WHERE a.IdPersonnel = $id AND t.EtatTache = 'Terminée'";
                ...
                <div class="personnel-header">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="personnel-info"><strong>ID:</strong> <?php echo $personnel['IdPersonnel']; ?></p>
