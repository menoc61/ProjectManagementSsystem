...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $idService = $_POST['idService'] ?: 'NULL';
    $competencesPersonnel = $_POST['competencesPersonnel'];
    $commentairesPersonnel = $_POST['commentairesPersonnel'];
    
    // Si idService est NULL, on doit le traiter différemment dans la requête SQL
    if ($idService === 'NULL') {
        $sql = "INSERT INTO PERSONNEL (NomPersonnel, PrenomPersonnel, EmailPersonnel, TelPersonnel, IdService, CompetencesPersonnel, CommentairesPersonnel) 
                VALUES ('$nomPersonnel', '$prenomPersonnel', '$emailPersonnel', '$telPersonnel', NULL, '$competencesPersonnel', '$commentairesPersonnel')";
    } else {
        $sql = "INSERT INTO PERSONNEL (NomPersonnel, PrenomPersonnel, EmailPersonnel, TelPersonnel, IdService, CompetencesPersonnel, CommentairesPersonnel) 
                VALUES ('$nomPersonnel', '$prenomPersonnel', '$emailPersonnel', '$telPersonnel', $idService, '$competencesPersonnel', '$commentairesPersonnel')";
    }
                        ...
                        <form method="post" action="create.php">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="idService" name="idService">
                                    ...
                                    ?>
                                    <option value="<?php echo $service['IdService']; ?>" <?php echo $preselectedService == $service['IdService'] ? 'selected' : ''; ?>>
